...
class DetailMovieFragmentTest {
    ...
    private val itemDescription = "Peter Parker is unmasked and no longer able to separate " +
            "his normal life from the high-stakes of being a super-hero. When he asks for help " +
            "from Doctor Strange the stakes become even more dangerous, forcing him to discover " +
